...
posts and the bloggers just happen to be using GitHub Pages, Jekyll, and, a few times, the Minimal Mistakes Jekyll theme.

This new (to me) tech stack would provide an easy way to add content (not like Google Sites) and still provide a static
site with decent performance. Thoughts starting falling into place and I saw the efficiency and learning opportunities.
...
Git for Windows allows me to create local source controled folders and to interact with GitHub. Even if you don't opt to
...
Visit GitHub Help for more information on how to [create a GitHub account](https://help.github.com/articles/signing-up-for-a-new-github-account/){:target="_blank"}, [create a respository](https://help.github.com/articles/create-a-repo/){:target="_blank"}, and
...
Each branch of my repo plays a particular role in the production of my blog.
...
GitHub Pages deploy sites using Jekyll and provides a [handul of themes](https://help.github.com/articles/about-jekyll-themes-on-github/){:target="_blank"}.
...
The theme has builtin support for Google Analytics. You simply add your site's tracking ID to the `_config.yml`
configuration file.
...
theme. When I want to get under the hood again of the theme, I will take a look at implementing it for this site.
{: .notice}
...
The pull request for a comment is saved to `_data\comments\<title-slug\comment-<date-time-stamp>.yml`. The vistor's
...
As Jekyll runs on Ruby, you will need to have a system that is capable of running Ruby and the Jekyll gems.
...
automatically, if at all possible. But that would entail me creating a listener on the VM that could be triggered by the
branch status change. I felt I had explored that rabbithole enough and backed out quickly.
